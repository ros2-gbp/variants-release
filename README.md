## variants (rolling) - 0.13.0-1

The packages in the `variants` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release variants -r rolling` on `Fri, 25 Apr 2025 20:36:51 -0000`
...
## variants (rolling) - 0.12.0-1

The packages in the `variants` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling variants` on `Wed, 09 Oct 2024 14:56:24 -0000`
...
## variants (jazzy) - 0.11.0-1

The packages in the `variants` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy variants` on `Tue, 30 Apr 2024 18:56:55 -0000`
...
- upstream repository: https://github.com/ros2/variants.git
- release repository: https://github.com/ros2-gbp/variants-release.git
- rosdistro version: `0.10.0-4`
- old version: `0.10.0-4`
...
## variants (rolling) - 0.10.0-1

The packages in the `variants` repository were released into the `rolling` distro by running `/home/steven/.local/bin/bloom-release -r rolling variants` on `Wed, 11 May 2022 18:45:51 -0000`
...
The packages in the `variants` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release -r eloquent variants` on `Tue, 10 Dec 2019 18:33:27 -0000`
